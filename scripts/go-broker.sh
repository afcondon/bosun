...
cat > "$REG" <<JSON
{
  ...
  "servers": [
    { "id": 1, "role": "worker", "projectName": "loopdemo", "projectId": "loopdemo",
    ...
    { "id": 2, "role": "api", "projectName": "rigdemo", "projectId": "rigdemo",
    ...
    { "id": 3, "role": "worker", "projectName": "udpdemo", "projectId": "udpdemo",
    ...
    { "id": 4, "role": "frontend", "projectName": "plaindemo", "projectId": "plaindemo",
      "port": $PROXY, "host": "mbp",
